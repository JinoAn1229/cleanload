...
//			return tempExp;
			...
			if(Math.abs(tempDiff) > Math.abs(diff/100))
			{
		...
		function FnSensorList()
		{
       	 ...
       	 function getTableData(jM)
		 {
			...
			if(nSelec < 0 || nEelec < 0 || isNaN(nSelec) || isNaN(nEelec))
				...
				tr_html += "<td>"+ (nEelec - nSelec) + "kWh</td>";
		...
		function fnExcelReport() {
			...
			tab_text += '<tr><th>시작 시간</th><th>종료 시간</th><th>물 사용량</th><th>전체 물 사용량</th><th>전력 사용량</th><th>전체 전력 사용량</th><th>노면온도변화</th><th>초미세먼지변화</th><th>미세먼지변화</th></tr>';
       ...
       <div  style="min-width: 400px" >
            <!-- //  header -->
             ...
             <div class="container" >
                 ...
                 <h3 class="tit-list">폴대 정보</h3>
                    <div class="search-wrap" >
                       <ul>
								<li>
								 <div class="dist">폴대목록</div>
									<div class="dist-cont">
