...
//			return tempExp;
		...
		function fnExcelReport() {
			...
			tab_text = tab_text + '<x:Name>poles Sheet</x:Name>';
			tab_text = tab_text + '<x:WorksheetOptions><x:Panes></x:Panes></x:WorksheetOptions></x:ExcelWorksheet>';
			tab_text = tab_text + '</x:ExcelWorksheets></x:ExcelWorkbook></xml></head><body>';
			tab_text = tab_text + "<table border='1px'>";

			tab_text += '<tr><th>시작 시간</th><th>종료 시간</th><th>물 사용량</th><th>전체 물 사용량</th><th>전력 사용량</th><th>전체 전력 사용량</th></tr>';
    ...
    <body>
		...
		<!--<header style="background: url('./images/header.png') center 0 no-repeat; background-size:100%; background-color: #00c1ff;">
				<img  src='./images/<%=p_strLogo%>'  style='width:220px;  float:left;'>
           	...
           	<jsp:include page="./left_menu.jsp"></jsp:include>		          	
                <div id="contents">
					<div class="container" >
						...
						<h3 class="tit-list">용수제어스테이션 정보</h3>
